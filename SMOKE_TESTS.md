...
- [ ] Ao selecionar Tales, Xitter, Pepeu e João, cargo e peso são preenchidos; participação permanece manual e vazia
...
- [ ] Usuário com `commission.delete` consegue excluir um registro antigo após confirmação, inclusive pago; o registro desaparece com pagamentos e histórico
...
- [ ] Aba Projetos mostra cards clicáveis e cada card abre o detalhamento correto
